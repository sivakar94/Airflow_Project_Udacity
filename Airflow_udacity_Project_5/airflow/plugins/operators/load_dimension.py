...
class LoadDimensionOperator(BaseOperator):
    ...
    :param string  truncate_table: 'YES' truncates table before load; 'NO' appends
    """
    ...
    def execute(self, context):
        ...
        insert_sql_final = f"INSERT INTO {self.table_name} {self.insert_sql}"
        self.log.info(f" insert sql: {insert_sql_final}")

        redshift_hook.run(insert_sql_final)
        self.log.info(f"LoadDimensionOperator insert complete - {self.table_name}")